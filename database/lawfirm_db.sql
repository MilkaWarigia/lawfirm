...
--
-- Host: localhost
-- Generation Time: Jan 17, 2026 at 04:16 AM
...
(1, 'Kamau vs. ABC Company', 'Civil', 'High Court Nairobi', 1, 'Active', 'Contract dispute case', '2026-01-16 17:47:35'),
(2, 'Kamau vs. ABC Company', 'Civil', 'High Court Nairobi', 1, 'Active', 'Contract dispute case', '2026-01-16 17:48:11');
...
(1, 3, 'milkah', '$2y$10$8SZwlsW39xQpSxGrOkPumuuewgnmxowfFpyy8R.WPx7keX4LGVCP6', 1, NULL, '2026-01-16 18:55:00');
...
--
ALTER TABLE `CASE_ASSIGNMENT`
  MODIFY `AssId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
