<?php
/**
 * RECEPTIONIST - MANAGE APPOINTMENTS/EVENTS
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($event_name) || empty($event_type) || empty($date)) {
...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
    try {
        ...
        $error = "Error loading appointment: " . $e->getMessage();
    }
}
...
<div class="card mt-20">
    ...
    <form method="POST" action="">
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary"><?php echo $edit_event ? 'Update Appointment' : 'Schedule Appointment'; ?></button>
            <?php if ($edit_event): ?>
