...
try {
    ...
    $stmt = $conn->query("SELECT b.*, c.CaseName, cl.FirstName, cl.LastName 
                         FROM BILLING b 
                         LEFT JOIN `CASE` c ON b.CaseNo = c.CaseNo 
                         LEFT JOIN CLIENT cl ON b.ClientId = cl.ClientId 
    ...
    // Upcoming Events - already detailed
    ...
    // Fetch summary data for cards and print
...
<div class="reports-grid">
    ...
    ?>
        <div class="report-card" onclick="openModal('billing-summary')">
            <div class="report-card-header">
                <h3 class="report-card-title">Billing Summary</h3>
    ...
    ?>
        <div class="report-card" onclick="openModal('cases-type')">
            <div class="report-card-header">
                <h3 class="report-card-title">Cases by Type</h3>
    ...
    ?>
        <div class="report-card" onclick="openModal('upcoming-events')">
            <div class="report-card-header">
                <h3 class="report-card-title">Upcoming Events</h3>
...
<div id="modal-cases-status" class="report-modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-folder-open"></i> Cases by Status - Detailed Report</h3>
...
<div id="modal-billing-summary" class="report-modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-dollar-sign"></i> Billing Summary - Detailed Report</h3>
...
<div id="modal-cases-type" class="report-modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-briefcase"></i> Cases by Type - Detailed Report</h3>
...
<div id="modal-upcoming-events" class="report-modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-calendar-alt"></i> Upcoming Events - Next 7 Days</h3>
...
<div class="print-content">
    <div class="print-header">
        ...
        <div class="report-info">
            <div>
                <strong>Report Type:</strong> Comprehensive System Reports<br>
                <strong>Generated By:</strong> <?php echo htmlspecialchars($_SESSION['user_name']); ?> (Administrator)
            </div>
    ...
    <div class="print-section">
        <h2><i class="fas fa-folder-open"></i> Cases by Status Report</h2>
        <?php
        $total_all_cases = count($all_cases);
        $total_by_status = [];
        foreach ($case_status as $stat) {
            $total_by_status[$stat['Status']] = $stat['count'];
        }
        ?>
    ...
    <div class="print-section">
        <h2><i class="fas fa-dollar-sign"></i> Billing Summary Report</h2>
        <?php
    ...
    <div class="print-section">
        <h2><i class="fas fa-briefcase"></i> Cases by Type Report</h2>
        <div class="print-summary">
    ...
    <div class="print-section">
        <h2><i class="fas fa-calendar-alt"></i> Upcoming Events Report (Next 7 Days)</h2>
        <div class="print-summary">
